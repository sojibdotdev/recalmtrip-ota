      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          ...
          >
            <Card>
              <CardHeader>
                <CardTitle className="bai-jamjuree-bold">Quick Actions</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                    ...
                    >
                      ...
                      <span className="bai-jamjuree-medium">Search Flights</span>
                    </Button>
                  </motion.div>
                  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                    <Button
                    ...
                    >
                      ...
                      <span className="bai-jamjuree-medium">View Saved</span>
                    </Button>
                  </motion.div>
                  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                    <Button variant="outline" className="w-full h-20 flex-col space-y-2">
                      <CreditCard className="w-6 h-6" />
                      <span className="bai-jamjuree-medium">My Bookings</span>
                    </Button>
                  </motion.div>
                  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                    <Button variant="outline" className="w-full h-20 flex-col space-y-2">
                      <User className="w-6 h-6" />
                      <span className="bai-jamjuree-medium">Settings</span>
                    </Button>
                  </motion.div>
                </div>
              </CardContent>
